...
df1["Source"] = "Computer B"
df2["Source"] = "Computer C"
...
variability = dfcat.groupby(['Source', 'Algorithm', 'ArraySizeA'])['AvgTime'].std().reset_index()
variability = variability.rename(columns={'AvgTime': 'StdDev'})


print(variability)
sns.barplot(data=variability, x='ArraySizeA', y='StdDev', hue='Source', errorbar=None)
plt.title('Runtime Variability by Array Size and Computer')
